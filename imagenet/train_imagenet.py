...
from rational.torch import RecurrentRational, Rational, EmbeddedRational
...
parser.add_argument('--selected_activation', default='relu6', type=str,
                    help='one of the standard activation functions or a rational activation function')
...
def main_worker(gpu, args):
    ...
    elif selected_actf == "ern":
        actv_function = EmbeddedRational
    ...
    if args.arch != 'mobilenet_v2' and 'efficientnet' not in args.arch and \
        ...
        raise ValueError('Rational Activation Functions not implemented for selected network architecture')
    ...
    if 'efficientnet' in args.arch:
        ...
        if "rn" in selected_actf:
            print("Optimizing with Rational activations")
